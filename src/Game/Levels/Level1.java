...
public class Level1 extends Level
{
    ...
    {
        if (Rectangle.collision(bg1.toRectangle(), cam))
        {
            bg1.render(g);
        }
        if (Rectangle.collision(bg2.toRectangle(), cam))
        {
            bg2.render(g);
        }
        ...
        for (int i = 0; i < bricks.size(); ++i)
        {
            ...
            if (Rectangle.collision(component.toRectangle(), cam))
            {
                if (Rectangle.collision(component.toRectangle(), player.toRectangle()))
                {
                    if (!gameover)
                    {
                        gameover = true;
        ...
        else if (winner)
        {
            ...
            if (diff >= 4000)
            {
                EngineController.getInstance().getGame().load(2);
            }
        }
    }
    ...
    public void tick()
    {
        ...
        if (Rectangle.collision(player.toRectangle(), world.toRectangle()))
        {
